...
?><!DOCTYPE HTML><html>
    <head>
        ...
        <meta http-equiv="Copyright" content="joean-doe-client GmbH, Bonn"/>        
...
<!--        <script type="text/javascript" src="js/markerClusterer.js"></script>
        ...
        <script type="text/javascript" src="min/g=public_js_1"></script>
<!--        <script type="text/javascript" src="include/javascript.onload.js">-->

        <?php
        // include('include/googletracking.inc.php');
        ?>

        <link type="text/css" href="http://joean-doe-client.de/apiext/styles.css" rel="stylesheet"/>
        <script type="text/javascript" src="http://joean-doe-client.de/apiext/script.js"></script>
    </head>
    <body>
        <div id="loader" style="width: 100%; height: 100%; z-index: 100000000; position: absolute; top:0; left:0; background: #ffffff; background-image: url('http://joean-doe-client.de/apiext/headerbox.png'); background-position: center;background-repeat: no-repeat;text-align: center;">
            ...
            <div id="gdmlogo" class="ui-widget ui-widget-content" style="width:30%; margin-top: 22%;margin-left: auto;margin-right: auto; opacity: .8">
                <img src="http://joean-doe-client.de/apiext/ui-anim_basic_16x16.gif" style="float: right"/>
        ...
        <div class="ui-layout-east" style="background: url(http://joean-doe-client.de/apiext/texture.png)">
            <img src="http://joean-doe-client.de/apiext/tablogo.png" style="height:60px; float: right; margin: 5px"/>
            ...
            <div id="suchdialog" class="ui-widget ui-widget-content ui-corner-all" style="padding: 5px;">
                ...
                <div title="Radius der Umkreissusche einstellen" id="umkreis" class="vtip ui-widget" style="height:8px; width: 80%;"></div>
            ...
            <div id="maindialog">
                <div id="tabs" style="float: right; width: 100%; height: 80%" class="ui-widget">
                    <ul id="tablist">
